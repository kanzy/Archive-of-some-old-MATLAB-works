...
[lambda_temp,lambda_order_temp]=sort(diag(lambda_unsorted));    %ascend
sizer_temp=size(lambda_temp);
for i=1:sizer_temp(1)
    lambda(i)=lambda_temp(sizer_temp(1)-i+1);
    lambda_order(i)=lambda_order_temp(sizer_temp(1)-i+1);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%KAN
...
for s=1:N_samples
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%KAN
    % [lambda_sorted,lambda_order]=sort(diag(lambda_unsorted),'descend');       %KAN:PROBLEM!!!
    [lambda_sorted_temp,lambda_order_temp]=sort(diag(lambda_unsorted));    %ascend
    sizer_temp=size(lambda_sorted_temp);
    for i=1:sizer_temp(1)
        lambda_sorted(i)=lambda_sorted_temp(sizer_temp(1)-i+1);
        lambda_order(i)=lambda_order_temp(sizer_temp(1)-i+1);
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%KAN

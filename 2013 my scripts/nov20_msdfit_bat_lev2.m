...
%%%for Nov20 test:
if currSampleNum<=5 && currSampleNum>1 %set the first 4 time points D constant
    xxx=find(DIndex2==103);
    lb(xxx)=0.8999;
    ub(xxx)=0.9001;
    
    xxx=find(DIndex2==104);
    lb(xxx)=0.8999;
    ub(xxx)=0.9001;
    
    xxx=find(DIndex2==105);
    lb(xxx)=0.8999;
    ub(xxx)=0.9001;
    
    xxx=find(DIndex2==106);
    lb(xxx)=0.8999;
    ub(xxx)=0.9001;
    
    xxx=find(DIndex2==107);
    lb(xxx)=0.8999;
    ub(xxx)=0.9001;
    
    xxx=find(DIndex2==108);
    lb(xxx)=0.8999;
    ub(xxx)=0.9001;
    
    xxx=find(DIndex2==109);
    lb(xxx)=0.8999;
    ub(xxx)=0.9001;
end
...
%         k=input('Input the number of start points to run (e.g. 50): ');
        ...
        ms = MultiStart;
        [DFit,fval,exitflag,output,solutions] = run(ms,problem,k_nsp); %not sure 30 is good

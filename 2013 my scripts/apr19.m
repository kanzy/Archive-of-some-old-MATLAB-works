%%%apr19.m: revised from apr18 & poolplot1.m for 3VN4 disulfides plot with
%%%peptide map
...
title(['MSDTC Peptide Map (total ', num2str(size(pool,1)), ' peptides & ', num2str(k), ' unique peptides)']) 
...
ssTable=zeros(12,2);
for i=1:12
    s1=VarName5(i)-(3-260 + 311-27);
    s2=VarName8(i)-(3-260 + 311-27);
    ssTable(i,:)=[s1,s2];

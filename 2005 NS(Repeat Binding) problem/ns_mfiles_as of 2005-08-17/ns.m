...
for simFitTimes=1:200
    ...
    iterNumCount(simFitTimes,1)=outputA.iterations;
    iterNumCount(simFitTimes,2)=outputB.iterations;
...
resultsA=[];
j=simFitTimes;   %//step-length of Segment for resultsA. Here fixed to only ONE segment! 

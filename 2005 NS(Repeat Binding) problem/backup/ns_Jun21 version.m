...
for simFitTimes=1:100
    ...
    %fitParaA=lsqnonlin(@kdfit, iniparaA, [0;-Inf;-Inf;-Inf;-Inf;-Inf],[]);
    ...
    %fitParaB=lsqnonlin(@kaufit,iniparaB,[0 0 0],[],options);
...
fitParaSet
save E:\USER\kanzy\ns\ns_data\fitParaSet.txt fitParaSet -ascii

...
if exist('simDarray','var')==1
    save(SaveFileName,'subdata','finalTable','proSeq','AnalyStart','AnalyEnd','useData','fitCondition','Algo','DIndex1','DIndex2','DFit','resNorm','DiffNorm','output')
else
    save(SaveFileName,'subdata','finalTable','proSeq','AnalyStart','AnalyEnd','useData','fitCondition','Algo','DIndex1','DIndex2','DFit','resNorm','output')
end

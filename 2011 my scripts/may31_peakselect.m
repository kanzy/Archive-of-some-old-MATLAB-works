...
function [selectPeaksRawMZ, selectPeaksInten]=may31_peakselect(selectPositions, expPeaks, mzThresholdAbs)

mzWeight=100; %weight coefficent of m/z closeness: exp(mzDiff*mzWeight)

selectPeaksRawMZ=-1*ones(size(selectPositions)); %2010-05-16 added, to store selectPeaks original m/z values

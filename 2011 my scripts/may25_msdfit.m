...
Algo=3 %input('Input the number of fitting algorithm to be used (1=lsqnonlin; 2=patternsearch; 3=multistart; 4=globalsearch): ');
...
switch Algo
    ...
    case 3
        k=input('Input the number of start points to run (e.g. 100): ');
